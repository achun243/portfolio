...
function setTagHTML(json) {
  ...
  for (var i=0; i < count_of_tags; i++) {
    var content = '<li class="navigation_tagItem"><a class="navigation_tagItemLink track_click ga_cat-sustainability ga_act-keyword-' + json[i]["query"] + '" href="/kr/sustainability/keyword/index.html?tag=' + json[i]["query"] + '">#' + json[i]["tag_name"] + '</a></li>';
    html.push(content)
  }
