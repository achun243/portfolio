...
$(window).load(function () {
  ...
  $('#wrapper').append(
      ...
      '<img src="/jp/sustainability/school/img/button_close.png" alt="">' +
      '</a>' +
    ...
    $("div#movie_modal_content").animate({
      ...
      complete: function () {
        ...
        if (!((ua.indexOf('iPhone') > 0 && ua.indexOf('iPad') === -1) || (ua.indexOf('Android') > 0 && ua.indexOf('Mobile Safari') > 0) || ua.indexOf('iPod') > 0 || ua.indexOf('BlackBerry') > 0)) {
          console.log("PC："+ua);
          $("#modalyoutube_player").html('<iframe width="960" height="540" src="' + href + '?rel=0&wmode=transparent&autoplay=1&autohide=1" frameborder="0" allowfullscreen></iframe>');
        } else {
          console.log("SP："+ua);
          $("#modalyoutube_player").html('<iframe width="300" height="169" src="' + href + '?rel=0&wmode=transparent&autoplay=1&autohide=1" frameborder="0" allowfullscreen></iframe>');
        }
      }
    });
  }
